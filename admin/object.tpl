								...
								<div class="sct_right" style="padding-top:50px;">
									...
									{else} {* PHOTOS TAB *}
											{if $FILTER.pictures}
												<div class="row">
													...
													{foreach from=$FILTER.pictures item=picture}
														<img src="../../../../upload_images/treasure_picture_{$picture.picture_id}.jpg" alt="{$picture}" style="width:150px; height:120px;"/>
											...
											{if $FILTER.main_picture}
												<div class="row">
													<label>&nbsp</label>
													<img src="../../../../upload_images/treasure_picture_{$FILTER.main_picture}.jpg" alt="{$picture}" style="width:150px; height:120px;"/>
