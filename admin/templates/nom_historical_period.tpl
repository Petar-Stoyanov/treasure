															...
															<td style="width: 120px;">
																<div class="actions_menu">
																	<ul>
																		...
																		<li>
																			{capture name=back_url}nom_historical_period.php{query_str} {/capture}
																			{if $item.hidden}
							...
							<div class="sct_left">
								<div class="sct_right">
									...
									<form class="search_form general_form" name='nom_frm' id='nom_frm' method="POST">
										<input type="hidden" name='back_url' value="nom_historical_period.php{query_str mode=null id=null}"/>
												...
												<div class="row">
													<div class="buttons">
														<ul>
															...
															<li><span class="button cancel_btn"><a href="nom_historical_period.php{query_str mode=null id=null}"><span><span>Cancel</span></span></a></span></li>
														</ul>
													</div>
												</div>
												<!--[if !IE]>end row<![endif]-->
