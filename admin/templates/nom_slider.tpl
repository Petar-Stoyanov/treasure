											...
											<div class="table_wrapper_inner">
												<table cellpadding="0" cellspacing="0" width="100%">
													<tbody><tr>
														...
														<th>{sorter_link sort_id=2 title='Picture'}</th>
														<th>Actions</th>
													</tr>
													...
													{if $FILTER.list}
														...
														{foreach from=$FILTER.list item=item}
															<tr class="{if $counter%2}second{else}first{/if}{if $item.hidden} hidden{/if}">
																...
																<td style="width: 1px;">
																<img src="image.php?mode=db&type=pictures&field=small_photo&id={$item.picture_id}" alt="{$picture}" /></td>
																...
																<td style="width: 120px;">
																	<div class="actions_menu">
																		<ul>
																			...
																			<li>
																				{capture name=back_url}nom_slider.php{query_str} {/capture}
																				{if $item.hidden}
								...
								<div class="sct_right" style="padding-top:50px;">
									...
									{if $FILTER.tab eq 1}
										...
										<form class="search_form general_form" name='nom_frm' id='nom_frm' method="POST">
											<input type="hidden" name='back_url' value="nom_slider.php{query_str mode=null id=null}"/>
												...
												<div class="forms">
													...
													<div class="row">
														...
														<div class="twoSelectionsInRow">
															<span class="input_wrapper"><input class="text" name="text" type="text" value="{$FILTER.item.text}"  validation="required"/></span>
															{if $errs.text}<span class="system negative">Mandatory field</span>{/if}
														</div>
													</div>
													...
													<div class="row">
														<div class="buttons">
															<ul>
																...
																<li><span class="button cancel_btn"><a href="nom_slider.php{query_str mode=null id=null}"><span><span>Cancel</span></span></a></span></li>
															</ul>
														</div>
													</div>
													<!--[if !IE]>end row<![endif]-->
...
{*												{foreach from=$FILTER.pictures item=picture} *}
												<img src="image.php?mode=db&type=pictures&field=small_photo&id={$FILTER.picture}" alt="{$picture}" />
														<span style="width: 30px;vertical-align:top;">
															<a href="del_image.php?mode=db&type=pictures&tbl=slider&id={$FILTER.picture}&back_url=nom_slider%2Ephp%3Fmode%3Dedit%26id%3D{$FILTER.id}%26tab%3D2" title="Изтрий"><img src="css/layout/site/tables/action4.gif" style="border:0"></a>
														</span>
        ...
        <script type="text/javascript">
			...
			function ajaxFileUpload(fileelemid) {
				...
				{/literal}
				var url = 'doajaxfileupload.php?mode=db&type=slider&tbl=slider&field=original_photo&id={$FILTER.id}&elem='+fileelemid;
				{literal}
