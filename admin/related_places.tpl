													...
													{if $FILTER.list}
														...
														{foreach from=$FILTER.list item=item}
															<tr class="{if $counter%2}second{else}first{/if}{if $item.hidden} hidden{/if}">
																...
																<td style="width: 1px;">
																<img src="../../../../upload_images/treasure_picture_{$item.picture_id}.jpg" alt="{$picture}" style="width:150px; height:120px;"/>
...
{*												{foreach from=$FILTER.pictures item=picture} *}
												<img src="../../../../upload_images/treasure_picture_{$FILTER.picture}.jpg" alt="{$picture}" style="width:150px; height:120px;"/>
